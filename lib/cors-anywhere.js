...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    // Special debugging endpoint: fetch and return https://www.cuitonline.com/
    if (req.method === 'OPTIONS' && req.url === '/debug-cuit') {
      res.writeHead(200, {'Access-Control-Allow-Origin': '*'});
      res.end();
      return;
    }

    if (req.method === 'GET' && req.url === '/debug-cuit') {
      var debugUrl = 'https://www.cuitonline.com/';
